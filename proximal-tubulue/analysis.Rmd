...
detected = rbind(k562_grch37_detected, h1_detected, h2_detected, h3_detected,
                 k562_refseq_detected, h1_detected, h2_detected, h3_detected,
...
## Read QC
We only end up keeping around 20-25 million reads per sample at the end for each
sample after trying to match up the barcodes despite having around 60-70 million
reads per sample.

## Alignment QC
Aligning to the Ensembl transcripts gives us 40 million total alignments and
to the RefSeq transcripts about half of that for the H1-H3 samples. The reverse
is true for the K562 samples.
